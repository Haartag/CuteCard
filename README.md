...
[![Version](https://img.shields.io/badge/version-0.2.11-blue)](https://github.com/llin-pixel/CuteCard/releases/tag/v0.2.11)
...
```kotlin
implementation("site.llinsoft:cutecard:0.2.11")
```
